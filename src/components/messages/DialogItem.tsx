...
import { IDialogItem } from "./index.type";
...
export const DialogItem = ({
  ...
  const color: number = Math.round(Math.random() * 12);

  const screen: number = window.screen.availWidth;
  ...
  return (
    ...
    >
      <div style={{ display: "flex" }}>
        <div
          style={{ backgroundColor: !avatar ? colors[3] : undefined }}
